...
<body>
    ...
    <section class="reservation-bar">
        ...
        <input type="hidden" id="schedulingType" value="${restaurant.schedulingType}" />

        <form action="${pageContext.request.contextPath}/reservation" method="post">

            <input type="hidden" name="restaurantId" value="${restaurant.id}" />
            <input type="hidden" name="date" value="${selectedDate}" />
            <c:if test="${restaurant.schedulingType == 'DATE_ONLY'}">
                <input type="hidden" id="hiddenServiceInstanceId" name="serviceInstanceId" value="" />
            </c:if>
            <%-- DATE SELECTION --%>
            ...
            <select id="timeSelect"
                    ...
                    required
                    <c:if test="${restaurant.schedulingType == 'DATE_ONLY'}">disabled</c:if>>
